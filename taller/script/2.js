...
const infoCurso = {
    ...
    <div class="accordion-content">
        <div class="tabs-container" id="tabs-u1">
            <div class="tabs-header">
                <button class="tab-btn active" data-tab="t1-u1">🖥️ ¿Qué es un Computador?</button>
                <button class="tab-btn" data-tab="t2-u1">⚙️ Hardware</button>
                <button class="tab-btn" data-tab="t3-u1">💻 Software</button>
                <button class="tab-btn" data-tab="t4-u1">🐧 Sistema Operativo Linux</button>
                <button class="tab-btn" data-tab="t5-u1">🗂️ El Escritorio Linux</button>
                <button class="tab-btn" data-tab="t6-u1">🪟 Manejo de Ventanas</button>
            </div>
            <div class="tabs-content">
                <div class="tab-pane active" id="t1-u1">
...
u2: `
    ...
    <div class="accordion">
        ...
        <div class="accordion-content">
            <div class="tabs-container" id="tabs-u2">
                <div class="tabs-header">
                    <button class="tab-btn active" data-tab="t1-u2">🖥️ ¿Qué es LibreOffice Writer?</button>
                    <button class="tab-btn" data-tab="t2-u2">🧭 Interfaz de Writer</button>
                    <button class="tab-btn" data-tab="t3-u2">✨ Formato de Texto y Párrafo</button>
                    <button class="tab-btn" data-tab="t4-u2">📊 Insertar y Editar Tablas</button>
                    <button class="tab-btn" data-tab="t5-u2">🖼️ Insertar y Ajustar Imágenes</button>
                </div>
                <div class="tabs-content">
                    <div class="tab-pane active" id="t1-u2">
...
`,
    u3: `
        ...
        <div class="accordion">
            ...
            <div class="accordion-content">
                <div class="tabs-container" id="tabs-u3">
                    <div class="tabs-header">
                        <button class="tab-btn active" data-tab="t1-u3">🎭 ¿Qué es Impress?</button>
                        <button class="tab-btn" data-tab="t2-u3">🧭 Interfaz de Impress</button>
                        <button class="tab-btn" data-tab="t3-u3">➕ Crear y organizar diapositivas</button>
                        <button class="tab-btn" data-tab="t4-u3">🖼️ Insertar objetos</button>
                        <button class="tab-btn" data-tab="t5-u3">✨ Animaciones y Transiciones</button>
                    </div>
                    <div class="tabs-content">
                        <div class="tab-pane active" id="t1-u3">
    ...
    u4: `
        ...
        <div class="accordion">
            ...
            <button class="accordion-btn">📚 Parte Teórica</button>
            <div class="accordion-content">
                <div class="tabs-container" id="tabs-u4">
                    <div class="tabs-header">
                        <button class="tab-btn active" data-tab="t1-u4">🧮 ¿Qué es Calc?</button>
                        <button class="tab-btn" data-tab="t2-u4">🧭 Interfaz de Calc</button>
                        <button class="tab-btn" data-tab="t3-u4">🔢 Fórmulas básicas</button>
                        <button class="tab-btn" data-tab="t4-u4">📊 Crear gráficos</button>
                    </div>
                    <div class="tabs-content">
                        <div class="tab-pane active" id="t1-u4">
    ...
    u5: `
        ...
        <div class="accordion">
            ...
            <button class="accordion-btn">📚 Parte Teórica</button>
            <div class="accordion-content">
                <div class="tabs-container" id="tabs-u5">
                    <div class="tabs-header">
                        <button class="tab-btn active" data-tab="t1-u5">🌍 ¿Qué es Internet?</button>
                        <button class="tab-btn" data-tab="t2-u5">🦊 Navegador Firefox</button>
                        <button class="tab-btn" data-tab="t3-u5">🔍 Búsqueda efectiva</button>
                        <button class="tab-btn" data-tab="t4-u5">✉️ Correo electrónico y Netiqueta</button>
                    </div>
                    <div class="tabs-content">
                        <div class="tab-pane active" id="t1-u5">
